...
<main class="perfil-main">
    ...
    <div class="perfil-container" id="perfilContainer">
        ...
        <div class="perfil-topo">
            ...
            <!-- FOTO -->
            <div class="foto-area">
                <img src="<?php echo htmlspecialchars($fotoPerfil); ?>" class="foto-perfil"  id="fotoPerfil">

                <form action="upload-foto.php" method="POST" enctype="multipart/form-data" id="formFoto">
                    <input type="file" name="foto" id="fotoInput" accept="image/png,image/jpeg,image/webp" hidden>
                    <button type="button" class="trocar-foto" id="btnTrocarFoto" title="Trocar foto">✎</button>
                </form>
            ...
            <div class="dados-perfil">
                ...
                <button type="button" class="entrar-conta" id="btnMinhaConta">Minha conta</button>
            </div>
        ...
        <div class="configuracoes" id="configuracoes">
            ...
            <!-- nome -->
            <div class="config-item config-clicavel" id="abrirNome">

                <div class="config-texto"><i>👤</i>
                    <div>
                        <h3>Nome</h3>
                        <p>
                            <?php
            ...
            <form action="atualizar-conta.php" method="POST" class="form-edicao" id="formNome">
            ...
            <!-- email -->
            <div class="config-item config-clicavel" id="abrirEmail">
            ...
            <form action="atualizar-conta.php" method="POST" class="form-edicao" id="formEmail">
            ...
            <!-- senha -->
            <div class="config-item config-clicavel" id="abrirSenha">
                <div class="config-texto">
                    <i>🔒</i>
                    <div>
                        <h3>Senha</h3>
            ...
            <form action="trocar-senha.php" method="POST" class="form-edicao" id="formSenha">
        ...
        <!-- sair da conta -->
        <button type="button" class="sair-conta" id="btnSair">↪ Sair da conta</button>
...
modoEscuro.addEventListener("change", alternarTema);
...
const abrirNome = document.getElementById("abrirNome");
const abrirEmail = document.getElementById("abrirEmail");
const abrirSenha = document.getElementById("abrirSenha");
...
if (abrirNome && formNome) {

    abrirNome.addEventListener("click", () => {

        const aberto = formNome.classList.contains("aberto");
...
if (abrirEmail && formEmail) {

    abrirEmail.addEventListener("click", () => {

        const aberto = formEmail.classList.contains("aberto");
...
if (abrirSenha && formSenha) {

    abrirSenha.addEventListener("click", () => {

        const aberto = formSenha.classList.contains("aberto");
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    if (!btnTrocarFoto || !fotoInput || !formFoto) {
        console.log("Algum elemento da foto não foi encontrado");
        return;
    }
